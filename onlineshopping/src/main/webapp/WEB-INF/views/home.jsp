                    ...
                    <div class="col-sm-4" ng-repeat="product in pCtrl.mvProducts">                    	
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <a ng-href="${contextRoot}/show/{{product.id}}/product" class="btn btn-primary pull-right">Chi tiết</a>
                            </div>
                        </div>
...
<!--                         <h4>Mua thêm sản phẩm khác!</h4> -->
                        <hr/>
                        <a class="btn btn-primary" href="${contextRoot}/show/all/products">Hiển thị thêm</a>
                    </div>
