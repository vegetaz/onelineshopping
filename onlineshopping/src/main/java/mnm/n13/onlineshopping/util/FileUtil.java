package mnm.n13.onlineshopping.util;
...
public class FileUtil {
	...
	private static final String ABS_PATH = "D:/eclipse-workspace/onlineshopping/src/main/webapp/assets/images/";
	...
	public static String uploadFilePath(HttpServletRequest request, MultipartFile file, String code, String contextPath) 
	{				
		// get the real server path
		REAL_PATH = request.getSession().getServletContext().getRealPath("/assets/images/");
		...
		return contextPath + "/resources/images/" + code + ".jpg";
	}
