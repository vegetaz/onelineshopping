CREATE DATABASE  IF NOT EXISTS `onlineshopping` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `onlineshopping`;
...
INSERT INTO `address` VALUES (1,4,'444','Hoàng Hoa Thám','Thuỵ Khuê','Tây Hồ','Hà Nội','100000',1,0),(2,5,'27/33','Đốc Ngữ','Liễu Giai','Ba Đình','Hà Nội','100000',1,0),(3,6,'27/33','Doc Ngu','Lieu Giai','Ba Dinh','Ha Noi','100000',1,0),(4,7,'27/33','Đốc NGữ','Liễu Giai','Ba Đinh','Hà Lội','100000',1,0),(5,8,'Ngõ 80','Xuân Phương','Phương Canh','Nam Từ Liêm','Hà Nội','24071995',1,0),(6,9,'Nhà không có chó','1','Phương Canh','Nam Từ Liêm','Hà Lội','1234',1,0),(7,10,'1','1','1','1','1','1',1,0),(8,11,'1','1','1','1','1','1',1,0);
...
CREATE TABLE `log_amount` (
  ...
  `email` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `amount` int(100) DEFAULT '0',
  `path_image` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `order_detail` (
  ...
  `image_path` varchar(500) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `status` int(11) DEFAULT '0',
  PRIMARY KEY (`id`),
...
-- Dump completed on 2019-05-05  2:13:26
